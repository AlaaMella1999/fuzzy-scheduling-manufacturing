...
**Cours:** Fundamentals of Programming (FTP) - Doctorat  
...
4. **Peng, Y., & Kong, X.** (2020). "A hybrid fuzzy inference system for job shop scheduling." *Journal of Manufacturing Systems*, 57, 232-247.
...
*Ce rapport a été rédigé dans le cadre du projet de fin de cours Fundamentals of Programming (FTP) pour le programme doctoral en informatique.*
